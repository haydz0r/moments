...
(defn auto-format
  ...
  [time-period]
  (cond 
    (and (= (abs (.getYears time-period)) 0) (= (abs (.getMonths time-period)) 0)) (add-tense time-period (str (abs (.getDays time-period)) " days"))
    (and (= (abs (.getYears time-period)) 0) (> (abs (.getMonths time-period)) 0)) (add-tense time-period (str (abs (.getMonths time-period)) " months " (abs (.getDays time-period)) " days"))
